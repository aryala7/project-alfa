                            ...
                            <div class="d-flex align-items-start list-item card-spacer-x py-3" data-inbox="message">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex align-items-center flex-wrap w-xxl-200px mr-3" data-toggle="view">
                                        ...
                                        <a href="#" class="font-weight-bold text-dark-75 text-hover-primary">{{$message->name}}</a>
                                    </div>
                                    <!--end::Author-->
                                </div>
                                <!--end::Toolbar-->
                                ...
                                <div class="flex-grow-1 mt-2 mr-2" data-toggle="view">
                                    <div>
                                        <span class="font-weight-bolder font-size-lg mr-2">{{$message->email}}</span>
                                ...
                                <!--end::Info-->
                                <!--begin::Datetime-->
                                <div class="mt-2 mr-3 font-weight-bolder w-50px text-right" data-toggle="view">{{$message->created_at->format('H:i')}}</div>
                                <!--end::Datetime-->
                            </div>
                            @empty
                            @endforelse
