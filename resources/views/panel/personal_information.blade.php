        ...
        <div class="card card-custom card-stretch">
            ...
            <div class="card-body pt-4">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="symbol-label" style="background-image:url('{{$me->file->address}}')"></div>
                        <i class="symbol-badge bg-success"></i>
                    </div>
                    <div>
                    <a href="#" class="font-weight-bolder font-size-h5 text-dark-75 text-hover-primary">{{$me->name}}</a>
                ...
                <div class="py-9">
                    <div class="d-flex align-items-center justify-content-between mb-2">
                        ...
                        <a href="#" class="text-muted text-hover-primary">{{$me->email}}</a>
                    </div>
                    <div class="d-flex align-items-center justify-content-between mb-2">
                        <span class="font-weight-bold mr-2">Phone:</span>
                        <span class="text-muted">{{$me->cellphone}}</span>
                    </div>
        ...
        <div class="card card-custom card-stretch">
            ...
            <div class="card-header py-3">
                ...
                <div class="card-toolbar">
                    <button type="submit" form="info-form" class="btn btn-success mr-2">Save Changes</button>
                    <button type="reset" class="btn btn-secondary">Cancel</button>
                </div>
            </div>
            <!--end::Header-->
            <!--begin::Form-->
            <form class="form" id="info-form" method="post" action="{{route('info.update')}}" enctype="multipart/form-data">
                @csrf
                <!--begin::Body-->
                <div class="card-body">
                    <div class="row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9 col-xl-6">
                            <div class="image-input image-input-outline" id="kt_profile_avatar" style="background-image: url('{{$me->file->address}}')">
                                <div class="image-input-wrapper" style="background-image: url('{{$me->file->address}})'"></div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9 col-xl-6">
                        <input name="first_name" class="form-control form-control-lg form-control-solid" type="text" value="@if($me->name){{$me->name}}@else{{old('name')}}@endif" />
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-xl-3 col-lg-3 col-form-label text-right">Last Name</label>
                        <div class="col-lg-9 col-xl-6">
                            <input name="last_name" class="form-control form-control-lg form-control-solid" type="text" value="Bold" />
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-xl-3 col-lg-3 col-form-label text-right">about me</label>
                        <div class="col-lg-9 col-xl-6">
                        <textarea rows="5" name="description" class="form-control form-control-lg form-control-solid" type="text">@if($me->description){{$me->description}}@else{{old('description')}}@endif</textarea>
                        </div>
                    </div>
